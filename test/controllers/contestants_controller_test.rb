...
class ContestantsControllerTest < ActionController::TestCase
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post :create, contestant: { email: @contestant.email, may_contact: @contestant.may_contact, points: @contestant.points }
    end
  ...
  test "should update contestant" do
    patch :update, id: @contestant, contestant: { email: @contestant.email, may_contact: @contestant.may_contact, points: @contestant.points }
    assert_redirected_to contestant_path(assigns(:contestant))
  end
